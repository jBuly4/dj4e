...
class CreateForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        instance = super(CreateForm, self).save(commit=False)  # super().save() should work the same way
...
class CommentForm(forms.Form):
    comment = forms.CharField(required=True, max_length=500, min_length=3, strip=True, label='Comments')
